  ...
  return (
    <div className="flex p-2 items-start justify-start">
      <div className="flex flex-col bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-zinc-800 via-black to-black items-center gap-5 pt-[5rem] p-3 justify-center rounded-xl w-full">
        <h1 className="text-gray-200 text-7xl leading-[4rem] font-extrabold">
          COLLECTION
        </h1>
        <p className="text-xl text-gray-300">clicked by our crew</p>
        <button className="p-5 text-lg gap-3 text-gray-400 hover:gap-5 flex items-center justify-between bg-[#0e0d0d] rounded-md transition-all font-semibold py-2 mt-5">
        ...
        <div className="grid w-full bg-black mt-[5rem] auto-rows-[20rem] grid-cols-1 gap-1 sm:grid-cols-2 md:grid-cols-3">
          {images.slice(0, 10).map((imageAndAuthor, i) => (
            <div
              key={i}
              className={`relative row-span-1 border-2 border-slate-400/10 ${
                i === 3 || i === 6
            ...
            >
              ...
              />
              <a href={`https://drive.google.com/file/d/${imageAndAuthor[0]}/view?usp=sharing`}>
...
export default PhotoAreenBento;
